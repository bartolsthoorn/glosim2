...
if __name__ == '__main__':
    ...
    parser.add_argument("-nt","--nthreads", type=int, default=1, help="Number of threads (1,2,4,6,9,12,16,25,36,48,64,81,100).")
    parser.add_argument("-np","--nprocess", type=int, default=32, help="Number of processes to run in parallel.")
    parser.add_argument("-nc","--nchunks", type=int, default=1, help="Number of chunks to divide the global kernel matrix in.")
